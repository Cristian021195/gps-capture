...
- `src/interfaces`: interfaces de typescript del proyecto
...
- `src/utils`: funciones normalmente puras, que no dependen del dominio de la aplicación.
...
- Siempre enfocarse en la estructura `src/IEntidades, src/IEntidadesDB, src/db/db.ts`.
- Evitar `any`.